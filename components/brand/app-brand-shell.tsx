      ...
      {pathname !== "/" && (
        <header className={styles.header}>
          <div className={styles.inner}>
            ...
            {isAdmin ? isAdminLogin ? <span className={styles.adminArea}>Office administration</span> : <nav className={styles.adminNav} aria-label="Office navigation"><Link href="/admin/dashboard">Dashboard</Link><Link href="/admin/vendor-applications">Vendor applications</Link><Link href="/admin/service-locations">Service locations</Link><Link href="/admin/users">Office users</Link></nav> : <nav aria-label="Page navigation">
              <Link href="/">Home</Link>
