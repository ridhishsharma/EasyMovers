...
interface BookingCancelRouteContext {
  params: Promise<{
    bookingId: string;
  }>;
}
...
export async function PATCH(
  request: NextRequest,
  context: BookingCancelRouteContext
...
async function resolveBookingId(
  ...
  if (!normalized) {
    throw new BookingCancelRouteRequestError(
...
class BookingCancelRouteRequestError extends Error {
  constructor(
    message: string,
    ...
    this.name =
      "BookingCancelRouteRequestError";

    Object.setPrototypeOf(
      this,
      BookingCancelRouteRequestError.prototype
    );
  }
}
